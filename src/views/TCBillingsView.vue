<template>
    ...
    <div class="billing-record-inner">
      ...
      <div class="billing-top-toolbar animate__slideInUp billing-animate-fill billing-animate-delay-1">
        <div class="billing-controls-stack">
          ...
          <div class="billing-search-outer flex items-center">
            <div class="flex-none">
            <button
            ...
            <div class="billing-search-wrap flex-none">
  ...
  <!-- scroll wrapper -->
  <div class="billing-table-scroll max-h-[420px] overflow-y-auto">
    ...
    <table class="billing-table">
      ...
      <tbody>
        ...
        >
          ...
          <!-- Control # -->
          <td class="billing-td-muted">
            <div class="max-h-20 overflow-hidden">
              {{ checkIfEmpty(i.ctrl_num) }}
            </div>
          </td>
          ...
          <!-- Next billing -->
          <td class="billing-td-center billing-td-muted">
            <div class="max-h-20 overflow-hidden">
          ...
          <td class="billing-td-muted">
            <div class="max-h-20 overflow-hidden">
              {{ getDateShort(i.datetime_added) }}
            </div>
          </td>

          <!-- Actions -->
          <td class="billing-td-actions">
            <div class="billing-actions max-h-20 overflow-hidden">
              ...
              >
                <svg class="w-5 h-5 billing-icon-ellipsis" fill="currentColor" viewBox="0 0 24 24">
              ...
              >
                <button
                  type="button"
                  class="billing-actions-popover-item"
                  @click="onActionMenuView(i.id)"
                >
                  View details
                </button>
              </div>
