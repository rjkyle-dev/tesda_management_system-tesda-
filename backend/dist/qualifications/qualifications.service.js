...
let QualificationsService = class QualificationsService {
    ...
    async findItem(id) {
        return await this.i_repository.createQueryBuilder("qualifications")
            .leftJoinAndMapOne('qualifications.category_id', entities_1.CategoriesEntity, 'category', 'qualifications.category_id = category.id')
...
exports.QualificationsService = QualificationsService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(entities_1.QualificationsEntity)),
