...
const user_types_entity_1 = require("./user_types.entity");
const user_types_controller_1 = require("./user_types.controller");
...
exports.UserTypesModule = UserTypesModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([user_types_entity_1.UserTypesEntity])],
        controllers: [user_types_controller_1.UserTypesController],
        providers: [user_types_service_1.UserTypesService],
    })
], UserTypesModule);
//# sourceMappingURL=user_types.module.js.map