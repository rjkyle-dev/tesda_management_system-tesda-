...
const user_profile_controller_1 = require("./user_profile.controller");
...
exports.UserProfileModule = UserProfileModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([user_profile_entity_1.UserProfileEntity])],
        controllers: [user_profile_controller_1.UserProfileController],
        providers: [user_profile_service_1.UserProfileService],
    })
], UserProfileModule);
//# sourceMappingURL=user_profile.module.js.map